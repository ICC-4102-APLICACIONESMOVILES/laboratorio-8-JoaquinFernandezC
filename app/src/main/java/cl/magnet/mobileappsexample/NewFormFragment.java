...
public class NewFormFragment extends Fragment {
    ...
    private EditText mEditIdFormView;
    private EditText mEditTextFormView;
    private EditText mEditDateFormView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEditIdFormView = getView().findViewById(R.id.edit_id);
        mEditTextFormView = getView().findViewById(R.id.edit_title);
        mEditDateFormView = getView().findViewById(R.id.edit_date);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Integer id = Integer.parseInt(mEditIdFormView.getText().toString());
                String title = mEditTextFormView.getText().toString();
                String date = mEditDateFormView.getText().toString();
